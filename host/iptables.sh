...
#    do
#        iptables -t nat -A PREROUTING -i br0 -p tcp -d $server_ip --dport http -j DNAT --to 192.168.83.31:80
#        iptables -t nat -A PREROUTING -i br0 -p tcp -d $server_ip --dport https -j DNAT --to 192.168.83.31:443
#    done
